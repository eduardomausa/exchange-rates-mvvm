...
//  ExchangeRates
//
//  Created by Eduardo Mausa on 21/09/23.
//
...
class FluctuationViewModel: ObservableObject {
    @Published var fluctuations: [Fluctuation] = [
        ...
        Fluctuation(symbol: "EUR", change: -0.0008, changePct: -0.4175, endRate: 0.18857),
        Fluctuation(symbol: "GBP", change: 0.0008, changePct: 0.4175, endRate: -0.18857)
    ]
}
