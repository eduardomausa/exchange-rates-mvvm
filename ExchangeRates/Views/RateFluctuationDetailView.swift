...
//  ExchangeRates
//
//  Created by Eduardo Mausa on 02/10/23.
//
...
class RateFluctuationViewModel: ObservableObject {
    ...
    @Published var chartComparations: [ChartComparation] = [
        ...
        ChartComparation(symbol: "USD", period: "2022-11-12".toDate(), endRate: 0.188657),
        ChartComparation(symbol: "USD", period: "2022-11-11".toDate(), endRate: 0.1979786),
